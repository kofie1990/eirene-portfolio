              ...
              <AnimatePresence>
                {businessesDropdownOpen && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-2 w-56 bg-background/95 backdrop-blur-md border border-white/10 rounded-sm shadow-xl py-2 flex flex-col"
                  >
                    <Link href="/nbn-beauty" className="px-6 py-3 hover:bg-white/5 hover:text-accent transition-colors">
                      NBN Beauty
                    </Link>
                    <Link href="/the-linkedin-fix" className="px-6 py-3 hover:bg-white/5 hover:text-accent transition-colors">
                      The LinkedIn Fix
                    </Link>
                    <Link href="/go1218" className="px-6 py-3 hover:bg-white/5 hover:text-accent transition-colors">
                      GO1218
                    </Link>
                  </motion.div>
                )}
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col items-center space-y-8 text-lg md:text-xl tracking-widest uppercase font-serif w-full px-6">
              ...
              <div className="w-full max-w-xs border-t border-b border-white/10 py-6 my-4 flex flex-col items-center space-y-6">
